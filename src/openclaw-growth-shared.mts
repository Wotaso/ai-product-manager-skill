...
function buildNativeNotificationOwnershipInstructions({
  nativeDeliveryEnabled,
  connectorHealthEnabled,
  growthRunEnabled,
}: {
  nativeDeliveryEnabled: boolean;
  connectorHealthEnabled: boolean;
  growthRunEnabled: boolean;
}) {
  return [
...
export function buildOpenClawGrowthSystemEvent(configPath, config = {}) {
  ...
  return [
    ...
    ...buildNativeNotificationOwnershipInstructions({
      ...
      connectorHealthEnabled: (config as any)?.notifications?.connectorHealth?.enabled !== false,
      growthRunEnabled: (config as any)?.notifications?.growthRun?.enabled !== false,
    }),
